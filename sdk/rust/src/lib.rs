...
pub mod wit {
    ...
    wit_bindgen::generate!({
        ...
        exports: {
            "fermyon:spin/inbound-http": Foo,
            "fermyon:spin/inbound-redis": Bar
        }
    });
}
...
pub mod inbound_http {
    ...
    impl<'a> TryFrom<spin_http_types::RequestParam<'a>> for http_types::Request<Option<bytes::Bytes>> {
        type Error = anyhow::Error;

        fn try_from(spin_req: spin_http_types::RequestParam<'a>) -> Result<Self, Self::Error> {
    ...
    fn append_request_headers(
        ...
        spin_req: &spin_http_types::RequestParam<'_>,
    ) -> anyhow::Result<()> {
    ...
    impl TryFrom<spin_http_types::Response> for http_types::Response<Option<bytes::Bytes>> {
        type Error = anyhow::Error;
    ...
    impl TryFrom<http_types::Response<Option<bytes::Bytes>>> for spin_http_types::Response {
        type Error = anyhow::Error;
